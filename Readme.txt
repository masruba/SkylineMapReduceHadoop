Implementation of the paper "Parallel computation of skyline and reverse skyline queries using mapreduce"
Link of the paper: http://dl.acm.org/citation.cfm?id=2556580
Dataset: http://www.cs.ucr.edu/~iabsa001/files/gsod_readme.txt
The code is tested in Cloudera VM.

This readme file explains how to run source code in Cloudera VM. Some of the path in the source are hard coded. So, they might need to change to give 
output. 
